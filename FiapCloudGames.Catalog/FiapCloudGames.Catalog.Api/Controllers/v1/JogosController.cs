...
namespace FiapCloudGames.Catalog.Api.Controllers.v1;

/// <summary>
/// API responsável pelo controle dos jogos
/// </summary>
/// <param name="jogoAppService">Serviço de aplicação de jogos</param>
/// <param name="validator">Validator de aplicação de jogos</param>
[ApiController]
[ApiVersion("1.0")]
